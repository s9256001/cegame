...
0. **代理推廣**
	- 規劃
		- [代理推廣網址]為 register.html?pid=[玩家ID]
		- 點擊[代理推廣網址]連到平台的註冊網頁, 介紹人 ID 會填代理的玩家 ID
	- 後台
		- 新增[推廣專區] > [代理推廣]頁面
		- 選擇推廣底圖, 產生[代理推廣網址], 與[代理推廣圖] (底圖+QR code https://www.the-qrcode-generator.com/) 供下載
		<br /><img src="https://raw.githubusercontent.com/s9256001/cegame/master/Platform/images/back/%E4%BB%A3%E7%90%86%E6%8E%A8%E5%BB%A3.png" width="320" height="auto" />
0. **活動推廣**
	- 規劃
